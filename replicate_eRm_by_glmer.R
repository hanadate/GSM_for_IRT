...
stargazer(compare.rasch, summary=FALSE, rownames=FALSE, 
          align=TRUE,
          label="tab:reprasch", 
          title="Result of applying \\texttt{eRm::RM} and \\texttt{lme4::glmer} for estimation of the Rasch model.
          Estimates of item parameters and their standard errors.")
# Create the plot
...
stargazer(compare.lltm, summary=FALSE, rownames=FALSE, 
          align=TRUE,
          label="tab:replltm", 
          title="Result of applying \\texttt{eRm::lltm} and \\texttt{lme4::glmer} for estimation of the LLTM.
          Estimates of item parameters and their standard errors.")
# Create the plot
...
stargazer(compare.rsm, summary=FALSE, rownames=FALSE, 
          align=TRUE,
          label="tab:reprsm", 
          title="Result of applying \\texttt{eRm::rsm} and \\texttt{lme4::glmer} for estimation of the RSM
          Estimates of item parameters and their standard errors.")
# Create the plot
...
stargazer(compare.lrsm, summary=FALSE, rownames=FALSE, 
          align=TRUE,
          label="tab:replrsm", 
          title="Result of applying \\texttt{eRm::lrsm} and \\texttt{lme4::glmer} for estimation of the LRSM
          Estimates of item parameters and their standard errors.")
# Create the plot
